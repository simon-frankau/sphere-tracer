/*
 * dof2.c: Depth of field demo 2, now with soft shadows
 *
 * (Copied from dof.c. C&P code is really bad, but I'm very, very lazy)
 *
...
int main(void) {
  scene *sc = make_scene();
  png_render(sc, WIDTH, HEIGHT, "dof2.png");
  return 0;
}
